...
<nav class="navbar navbar-expand-lg navbar-light navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="catalogue.do">### <span class="sr-only">(current)</span></a>

      </li>
      <li class="nav-item" >
      	<form class="form-inline my-2 my-lg-0" action="#.do" method="GET">
...
<!--       <li class="nav-item dropdown">
    ...
    <form action="getKitty.do" method="GET" class="form-inline my-2 my-lg-0">
      <input required name="id" class="form-control mr-sm-2" type="search" placeholder="Event" aria-label="Search">
